<%-- 
    Document   : AllUser
    Created on : 19-Nov-2023, 12:58:38 pm
    Author     : Mohan_Maali
--%>
...
<%       
        UserDAO[] usdao = (UserDAO[]) session.getAttribute("usdao");
        System.out.println(usdao[0].getName());
%>
                                        ...
                                        <div class="container mt-5 table-responsive">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <% int i =0;
                                                    while(usdao.length>i && usdao[i]!=null){
                                                    %>
                                                    <tr>
                                                        <td><%=usdao[i].getId()%></td>
                                                        <td><%=usdao[i].getName()%></td>
                                                        <td><%=usdao[i].getUserName()%></td>
                                                        <td><%=usdao[i].getEmail()%></td>
                                                        <td><%=usdao[i].getMobile()%></td>
                                                        <td><%=usdao[i].getGender()%></td>
                                                        <td><%=usdao[i].getAddress()%></td>
