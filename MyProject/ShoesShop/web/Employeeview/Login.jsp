<%-- 
    Document   : Login
    Created on : 19-Nov-2023, 1:44:54 pm
    Author     : Mohan_Maali
--%>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-5">
                                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                        ...
                                                        <div class="card-body">
                                                            <form  action="/ShoesShop/EmployeeLoginController" onsubmit="return validation()">
                                                                <div class="form-floating mb-3">
                                                                    <input name="email" onkeyup="emailvalidation()" class="form-control" id="email" type="email" placeholder="name@example.com" />
                                                                    <span id="erroremail">&nbsp;</span>
                                                                    <label for="inputEmail">Email address</label>
                                                                </div>
                                                                <div class="form-floating mb-3">
                                                                    <input name="password" onkeyup="passwordvalidation()"  class="form-control" id="password" type="password" placeholder="Password" />
                                                                ...
                                                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                                    <a class="small" href="#.html">Forgot Password?</a>
