                ...
                <div class="container py-5 h-100">
                    <div class="row d-flex justify-content-center align-items-center h-80">
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div id="container1" class="card text-white" style="border-radius: 2rem;">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <div class="mb-md-5 mt-md-4 pb-5">
                                        ...
                                        <div class="form-outline form-white mb-4">
                                            <input onkeyup="validateEmail()" name="email" type="email" id="typeEmailX" class="form-control form-control-lg" placeholder="Enter Admin Email-Id" />
                                            <span id="errorEamail">&nbsp;</span>
                                        </div>

                                        <div class="form-outline form-white mb-4">
                                            <input onkeyup="validatePassword()" name="password"  type="password" id="typePasswordX" class="form-control form-control-lg" placeholder="Enter Password" />
