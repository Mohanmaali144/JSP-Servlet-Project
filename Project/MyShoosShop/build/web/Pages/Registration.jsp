<%-- 
    ...
    Created on : 28-Oct-2023, 7:52:03 pm
    Author     : Mohan_Maali
--%>
                ...
                <div class="col-md-9 register-right">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <h3 class="register-heading">Sign Up Account</h3>
                            <form action="" onsubmit="return ValidateForm()">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input onkeyup="validateUserName()" name="username" type="text" class="form-control"
                                        ...
                                        <div class="form-group">
                                            <input onkeyup="validatePassword()" name="password" type="password" class="form-control"
                                                   placeholder="Password*" value="" />
                                            <span style="color: rgb(255, 95, 95);" id="erroUserPassword">&nbsp;</span>
                                        </div>
                                        <div class="form-group">
                                            <input onkeyup="validateCPassord()" name="cpassword" type="password" class="form-control"
                                                   placeholder="Confirm Password *" value="" />
                                            <span style="color: rgb(255, 95, 95);" id="erroUsercpassword">&nbsp;</span>
                                        </div>
                                        <div class="form-group">
                                            <div class="maxl">
    ...
    if(email!=null)
    {
          Connection con = null;
                            try {
                                ...
                                String sql = "select * from user_details where email=? OR mobile=? OR userName=?";
...
%>                  
<script>
    let error = document.getElementById("mainError");
...
//   response.sendRedirect("Registration.jsp");
    ...
    sql = "insert into user_details (userName,Fullname,email,mobile,gender,password,address) values(?,?,?,?,?,?,?)";
